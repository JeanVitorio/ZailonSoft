      ...
      <div className="min-h-screen bg-white text-zinc-800 font-poppins relative overflow-x-hidden">
        ...
        <main>
          <section id="inicio" className="relative w-full min-h-screen flex items-center pt-20">
            {/* --- INÍCIO DA ALTERAÇÃO: FUNDO RESPONSIVO --- */}
            {/* Fundo para Telas Grandes (Desktop) */}
            <div className="absolute inset-0 hidden lg:block bg-cover bg-center z-0" style={{ backgroundImage: `url(/BannerCamaro.png)` }}></div>
            {/* Fundo para Telas Pequenas (Mobile) */}
            <div className="absolute inset-0 block lg:hidden bg-cover bg-center z-0" style={{ backgroundImage: `url(/CamaroBranco.png)` }}></div>
            {/* --- FIM DA ALTERAÇÃO --- */}
              ...
              <div className="grid lg:grid-cols-5 gap-12 items-center">
                ...
                >
                  <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
                    Sua Concessionária <span className="text-amber-400">Faturando 24h por Dia.</span>
                  </motion.h1>
                  ...
                  <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                      <a
                        href="#download-bot"
                        className="w-full sm:w-auto inline-block bg-transparent border-2 border-zinc-300 text-zinc-100 px-8 py-4 rounded-lg font-bold text-lg flex items-center justify-center gap-2 transition-all hover:bg-zinc-100 hover:border-zinc-400 hover:text-zinc-800"
                      >
                        <Feather.DownloadCloud size={22} /> Baixar o Bot
                      </a>
                    </motion.div>
                  </motion.div>
                  <motion.p variants={fadeInUp} className="text-zinc-400 mt-4 text-sm">Download grátis. Ativação requer assinatura.</motion.p>
                </motion.div>
              </div>
            </div>
          </section>
