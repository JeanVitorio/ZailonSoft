      ...
      <div className="min-h-screen bg-white text-zinc-800 font-poppins relative overflow-x-hidden">
        ...
        <main>
          <section id="inicio" className="relative w-full min-h-screen flex items-center pt-20 bg-zinc-900">
            <div
              className="absolute inset-0 hidden lg:block bg-cover bg-center z-0 bg-no-repeat"
              style={{ backgroundImage: `url(/BannerCamaro.png)` }}
            ></div>
            <div
              className="absolute inset-0 block lg:hidden bg-cover bg-center z-0 bg-no-repeat"
              style={{ backgroundImage: `url(/CamaroBranco.png)` }}
            ></div>
