...
// NOVO: Componente para pontos de luz animados (ajustado para fundo claro)
const LightDotsBackground = () => {
  ...
  useEffect(() => {
    const generateDots = () => {
      const newDots = Array.from({ length: 70 }).map(() => ({
        ...
        animationDuration: `${Math.random() * 8 + 8}s`, // Duração entre 8s e 16s
        animationDelay: `${Math.random() * 8}s`,
        size: `${Math.random() * 2 + 1}px`, // Tamanho entre 1px e 3px
        opacity: `${Math.random() * 0.4 + 0.3}`, // Opacidade entre 0.3 e 0.7
      }));
      setDots(newDots);
    };
    generateDots();
  ...
  return (
    <>
      {/* CSS para a animação dos pontos */}
      <style>
        {`
          @keyframes move-dots {
            from {
          ...
          .light-dot {
            ...
            position: absolute;
            background-color: #a1a1aa; /* Cor dos pontos (cinza médio) */
            border-radius: 50%;
            z-index: -20; /* Garante que fique no fundo */
          }
        `}
      </style>
...
// MODIFICADO: Componente para o Fundo Animado (ajustado para fundo claro)
const AnimatedBackground = () => (
  <div className="absolute inset-0 -z-10 h-full w-full">
    {/* Cor do grid ficou um pouco mais sutil no fundo claro */}
    ...
    {/* Gradiente radial sutil de um amarelo claro para transparente */}
...
// Componente para o item do FAQ (Accordion) (com paleta ajustada para claro)
...
const HomePage = () => {
  ...
  // --- Efeitos de Animação (sem alteração) ---
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && !window.fbq) {
      ...
      window.fbq('init', 'SEU_PIXEL_ID'); // Substitua 'SEU_PIXEL_ID' pelo seu ID real do Pixel do Facebook
  ...
  return (
    <HelmetProvider>
      {/* MODIFICADO: Fundo principal da página agora é branco */}
      <div className="min-h-screen bg-white text-zinc-800 font-poppins relative overflow-x-hidden">
        ...
        {/* ADICIONADO: Novo componente de pontos de luz no fundo claro */}
        <LightDotsBackground />
        {/* O AnimatedBackground agora está por cima dos pontos mas abaixo do conteúdo, com estilo claro */}
        <AnimatedBackground />

        {/* MODIFICADO: Header com fundo de cor clara e texto escuro */}
        <header className="fixed top-0 left-0 w-full bg-white/70 backdrop-blur-lg border-b border-zinc-200 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
              <Link to="/" className="text-2xl font-bold tracking-wider text-blue"> {/* MANTIDO: 'text-white' para "Zailon" */}
                Zailon<span className="text-amber-500">Soft</span> {/* MANTIDO: 'text-amber-500' para "Soft" */}
              </Link>
        ...
        <main>
          <section id="inicio" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <motion.div variants={fadeInUp} initial="hidden" animate="visible">
                {/* MODIFICADO: Texto principal agora em cinza escuro */}
                ...
                {/* MODIFICADO: Texto secundário em cinza um pouco mais claro */}
          ...
          <section id="solucao" className="py-24 px-4 sm:px-6 lg:px-8 bg-zinc-50"> {/* MODIFICADO: Fundo mais claro para a seção */}
            <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                  <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                      {/* MODIFICADO: Sombra da imagem ajustada para fundo claro */}
          ...
          {/* MODIFICADO: Seção de planos com fundo mais claro */}
          <section id="planos" className="py-24 px-4 sm:px-6 lg:px-8 bg-zinc-100">
            <div className="max-w-4xl mx-auto text-center">
                ...
                {/* MODIFICADO: Card de planos com fundo branco e borda suave */}
        ...
        {/* MODIFICADO: Rodapé com fundo claro e texto escuro */}
