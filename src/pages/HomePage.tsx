...
import FalconHeroCar from '@/assets/Falcon-hero-car.jpg';
        ...
        <div className="container mx-auto px-3 sm:px-4 py-3">
          <div className="flex items-center justify-between gap-2">
            <Link to="/" className="flex items-center gap-2 sm:gap-3 min-w-0">
              <img src={FalconLogo} alt="Falcon" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex-shrink-0 object-contain" />
              <span className="text-base sm:text-lg font-bold text-gradient truncate">Falcon</span>
            </Link>
    ...
    <AnimatedSection className="text-center mb-14 max-w-2xl mx-auto">
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 mb-4">
        ...
        <span className="text-xs font-semibold text-red-300">
          Cada dia sem o Falcon é dinheiro perdido
        </span>
      </div>
      ...
      <p className="text-muted-foreground">
        Quem opera sem sistema, perde. Quem usa o Falcon, escala.
      </p>
    </AnimatedSection>
    ...
    <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <AnimatedSection>
            <div className="max-w-2xl mx-auto glass-card p-8 sm:p-10 rounded-3xl text-center relative overflow-hidden border-cyan-500/30 shadow-[0_20px_80px_-20px_rgba(7,171,216,0.35)]">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/15 border border-cyan-500/30 mb-4">
                ...
                <span className="text-[11px] font-bold text-cyan-300 uppercase tracking-wide">Plano Falcon Pro</span>
              </div>
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          {[
            { q: 'Preciso instalar algo?', a: 'Não. O Falcon é 100% online. Acesse pelo navegador do celular ou computador, em qualquer lugar.' },
            ...
            { q: 'Como meus clientes acessam o catálogo?', a: 'Você conecta o domínio próprio da sua loja e compartilha o endereço direto do catálogo por WhatsApp, Instagram ou onde quiser.' },
            ...
            { q: 'Funciona para loja pequena?', a: 'Especialmente. O Falcon foi desenhado para que uma pessoa só consiga operar uma loja inteira sem perder vendas.' },
          ].map((faq, i) => (
            <AnimatedSection key={i} delay={i * 0.06}>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <img src={FalconLogo} alt="Falcon" className="w-9 h-9 rounded-lg object-contain" />
              <div>
                <p className="text-sm font-semibold text-foreground">Falcon © {new Date().getFullYear()}</p>
