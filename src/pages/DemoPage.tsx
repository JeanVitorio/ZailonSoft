        ...
        <div className="relative container mx-auto px-4 py-6 md:py-12">
          <div className="flex items-center justify-between mb-6 md:mb-8">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-2 md:gap-3">
              ...
              <div>
                <h1 className="text-lg md:text-xl font-bold text-white">Falcon Demo</h1>
        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs md:text-sm text-muted-foreground">Falcon Demo © {new Date().getFullYear()}</span>
            </div>
