...
function CarDetailsDisplay({ vehicle }: { vehicle: Car }) {
  ...
  // NOVO: Estado para controlar a expansão da descrição
  ...
  // NOVO: Função para alternar a expansão da descrição
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {/* ALTERADO: Lógica para truncar a descrição e adicionar botão "Ver mais" */}
            ...
            {/* O botão só aparece se a descrição for maior que 200 caracteres */}
...
export function PublicCarFormPage() {
  ...
  const progressValue = dealType ? ((step) / (flowSteps.length + 1)) * 100 : 0;
